...
//  std::vector<std::vector<double>> &gravity_vectors_madg, std::vector<std::vector<double>> &gravity_vectors_gt, std::vector<std::vector<double>> &gravity_vectors_comp_mag, std::vector<std::vector<double>> &gravity_vectors_comp, std::string &_results_suffix)
// {
...
//     _results_suffix = results_suffix;
//     is_done = true;
//     loading = false;
//     // is_calculated = true;
//     return NULL;
...
int main(int argc, char* argv[])
{
    ...
    //     ImGui::SetNextWindowSize(ImVec2(720, 480), ImGuiCond_FirstUseEver);
        ...
        //             {
        //                 _t.join();
        //                 // _t = std::thread(&runFilter, freq, comp_gain, madg_beta, start_index, end_index, max_index, gravity_vectors_madg_mag, gravity_vectors_madg, gravity_vectors_gt, gravity_vectors_comp_mag, gravity_vectors_comp, _results_suffix);
        //                 _t = std::thread(&runFilter, std::ref(freq), std::ref(comp_gain), std::ref(madg_beta), std::ref(start_index), std::ref(end_index), std::ref(max_index), std::ref(gravity_vectors_madg_mag), std::ref(gravity_vectors_madg), std::ref(gravity_vectors_gt), std::ref(gravity_vectors_comp_mag), std::ref(gravity_vectors_comp), std::ref(_results_suffix));
        //             }
        //             else
        //             {
        ...
        //             // rmse = CsvReader::getRMSE(fPath, _results_suffix);

        //             // if(!save_to_file)
        //             // {
        //             //     std::filesystem::remove_all(fPath + _results_suffix);
        //             // }
