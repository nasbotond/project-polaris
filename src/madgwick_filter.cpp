...
//     qDot1 = 0.5f * (-q.q_2 * g.x - q.q_3 * g.y - q.q_4 * g.z);
//     qDot2 = 0.5f * (q.q_1 * g.x + q.q_3* g.z - q.q_4 * g.y);
//     qDot3 = 0.5f * (q.q_1 * g.y - q.q_2 * g.z + q.q_4 * g.x);
//     qDot4 = 0.5f * (q.q_1 * g.z + q.q_2 * g.y - q.q_3 * g.x);
...
//         recipNorm = 1.0f/sqrtf(m.x * m.x + m.y * m.y + m.z * m.z);
//         m.x *= recipNorm;
//         m.y *= recipNorm;
//         m.z *= recipNorm;

//         // Auxiliary variables to avoid repeated arithmetic
//         _2q0mx = 2.0f * q.q_1 * m.x;
//         _2q0my = 2.0f * q.q_1 * m.y;
//         _2q0mz = 2.0f * q.q_1 * m.z;
//         _2q1mx = 2.0f * q.q_2 * m.x;
//         _2q0 = 2.0f * q.q_1;
//         _2q1 = 2.0f * q.q_2;
//         _2q2 = 2.0f * q.q_3;
//         _2q3 = 2.0f * q.q_4;
//         _2q0q2 = 2.0f * q.q_1 * q.q_3;
//         _2q2q3 = 2.0f * q.q_3 * q.q_4;
//         q0q0 = q.q_1 * q.q_1;
//         q0q1 = q.q_1 * q.q_2;
//         q0q2 = q.q_1 * q.q_3;
//         q0q3 = q.q_1 * q.q_4;
...
//         s0 = -_2q2 * (2.0f * q1q3 - _2q0q2 - a.x) + _2q1 * (2.0f * q0q1 + _2q2q3 - a.y) - _2bz * q.q_3 * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - m.x) + (-_2bx * q.q_4 + _2bz * q.q_2) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - m.y) + _2bx * q.q_3 * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - m.z);
//         s1 = _2q3 * (2.0f * q1q3 - _2q0q2 - a.x) + _2q0 * (2.0f * q0q1 + _2q2q3 - a.y) - 4.0f * q.q_2 * (1 - 2.0f * q1q1 - 2.0f * q2q2 - a.z) + _2bz * q.q_4 * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - m.x) + (_2bx * q.q_3 + _2bz * q.q_1) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - m.y) + (_2bx * q.q_4 - _4bz * q.q_2) * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - m.z);
//         s2 = -_2q0 * (2.0f * q1q3 - _2q0q2 - a.x) + _2q3 * (2.0f * q0q1 + _2q2q3 - a.y) - 4.0f * q.q_3 * (1 - 2.0f * q1q1 - 2.0f * q2q2 - a.z) + (-_4bx * q.q_3 - _2bz * q.q_1) * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - m.x) + (_2bx * q.q_2 + _2bz * q.q_4) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - m.y) + (_2bx * q.q_1 - _4bz * q.q_3) * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - m.z);
//         s3 = _2q1 * (2.0f * q1q3 - _2q0q2 - a.x) + _2q2 * (2.0f * q0q1 + _2q2q3 - a.y) + (-_4bx * q.q_4 + _2bz * q.q_2) * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - m.x) + (-_2bx * q.q_1 + _2bz * q.q_3) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - m.y) + _2bx * q.q_2 * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - m.z);
...
//     q.q_1 += qDot1 * (1.0f / (1.0f/deltat));
//     q.q_2 += qDot2 * (1.0f / (1.0f/deltat));
//     q.q_3 += qDot3 * (1.0f / (1.0f/deltat));
//     q.q_4 += qDot4 * (1.0f / (1.0f/deltat));

//     // Normalise quaternion
//     recipNorm = 1.0f/sqrtf(q.q_1 * q.q_1 + q.q_2 * q.q_2 + q.q_3 * q.q_3 + q.q_4 * q.q_4);
//     q.q_1 *= recipNorm;
//     q.q_2 *= recipNorm;
//     q.q_3 *= recipNorm;
//     q.q_4 *= recipNorm;
